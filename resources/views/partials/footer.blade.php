        ...
        <div>
          <div x-data="{ dropdownOpen: false }" class="relative">
            ...
            <div x-show="dropdownOpen" class="absolute right-0 mt-2 py-2 w-48 bg-white rounded-md shadow-xl z-20">
              <a href="{{ route("hall.calendar") }}" class="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-red-500 hover:text-white">
                КАЛЕНДАРЬ СОРЕВНОВАНИЙ
              </a>
              <a href="{{ route("hall.history") }}" class="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-red-500 hover:text-white">
                ИСТОРИЯ БОРЬБЫ
              </a>
            </div>
          </div>
